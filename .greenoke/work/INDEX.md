...
|---|---|---|---|
| feature | meltfall-core-loop | shipped — QA gate PASS_WITH_DEFERRALS (spec→plan→build→QA complete) | juice/audio, tests, level-flow, monetization (future features) |

Decision: [meltfall-core-loop-build](../docs/decisions/meltfall-core-loop-build.md). QA verdict PASS_WITH_DEFERRALS (0 BLOCKING, 5 accepted deferrals).
